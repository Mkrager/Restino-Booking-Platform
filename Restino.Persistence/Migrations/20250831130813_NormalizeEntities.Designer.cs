...
namespace Restino.Persistence.Migrations
{
    ...
    [Migration("20250831130813_NormalizeEntities")]
    partial class NormalizeEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Restino.Domain.Entities.Accommodation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("47fc830b-751c-4b54-88e3-3281d746f3fd"),
                            ...
                            CreatedDate = new DateTime(2025, 10, 12, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("9db960f8-38e7-4fb4-8db5-6c82f65a654c"),
                            Address = "98 Main Blvd, Chicago, IL",
                            Capacity = 3,
                            CategoryId = new Guid("c119661c-1d5a-42c1-8819-6b0885af4d4a"),
                            CreatedDate = new DateTime(2025, 9, 10, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("6b7e2693-aa97-4f54-97cc-8cc3bdd5d130"),
                            Address = "303 Sky Tower, Los Angeles, CA",
                            Capacity = 5,
                            CategoryId = new Guid("c119661c-1d5a-42c1-8819-6b0885af4d4a"),
                            CreatedDate = new DateTime(2025, 9, 15, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("b3b8f3d5-9efe-497a-9454-d2d16965cfa0"),
                            Address = "121 Oak Street, Dallas, TX",
                            Capacity = 6,
                            CategoryId = new Guid("c119661c-1d5a-42c1-8819-6b0885af4d4a"),
                            CreatedDate = new DateTime(2025, 9, 20, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("ff38ccf6-d319-40d1-8869-c7ae8a415f5e"),
                        ...
                        new
                        {
                            Id = new Guid("e3132a60-2e38-4366-b0ac-59d653e3400f"),
                            Address = "22 Hilltop Ave, Aspen, CO",
                            Capacity = 7,
                            CategoryId = new Guid("8f67819c-0d09-43e8-b64f-17c9123b6040"),
                            CreatedDate = new DateTime(2025, 9, 12, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("826dace9-c0ba-40b2-bd92-41f9d6519a08"),
                            Address = "15 Ocean Blvd, Malibu, CA",
                            Capacity = 6,
                            CategoryId = new Guid("8f67819c-0d09-43e8-b64f-17c9123b6040"),
                            CreatedDate = new DateTime(2025, 9, 18, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("e7136862-7c13-4a57-a05f-e09b9ae98d06"),
                            Address = "30 Green Lane, San Francisco, CA",
                            Capacity = 5,
                            CategoryId = new Guid("8f67819c-0d09-43e8-b64f-17c9123b6040"),
                            CreatedDate = new DateTime(2025, 9, 25, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("eac0f796-b80d-43ff-800e-dfbe0a5dbb60"),
                        ...
                        new
                        {
                            Id = new Guid("97b5de46-c8fa-42ff-b752-e1baaf09a844"),
                            Address = "8 Pine Hill Rd, Lake Tahoe, CA",
                            Capacity = 5,
                            CategoryId = new Guid("418ade5f-d0b7-4545-b9de-beafbefffa66"),
                            CreatedDate = new DateTime(2025, 9, 8, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("90bea0a5-4dc5-4461-a6ca-ec2633ce4acf"),
                            Address = "25 Forest Road, Whistler, BC",
                            Capacity = 4,
                            CategoryId = new Guid("418ade5f-d0b7-4545-b9de-beafbefffa66"),
                            CreatedDate = new DateTime(2025, 9, 16, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("cdd387fe-0834-494b-9a63-2a622375d36c"),
                        ...
                        new
                        {
                            Id = new Guid("dcbbfc78-9191-4ced-97c6-da3c51b1adae"),
                        ...
                        new
                        {
                            Id = new Guid("48f6d005-6237-465c-a413-e2924e9773e8"),
                            Address = "14 Pinewood Rd, Asheville, NC",
                            Capacity = 4,
                            CategoryId = new Guid("cf0976f2-83c1-4708-afea-3e4785db6d66"),
                            CreatedDate = new DateTime(2025, 9, 30, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("70adcfec-32f1-4ae7-a67a-a1690c5ffaa9"),
                            Address = "22 Riverbank Dr, Jackson, WY",
                            Capacity = 6,
                            CategoryId = new Guid("cf0976f2-83c1-4708-afea-3e4785db6d66"),
                            CreatedDate = new DateTime(2025, 10, 6, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("0ff2a035-d55d-422c-a7c0-6a3eb4a2b51a"),
                            Address = "5 Ocean View St, Cape Cod, MA",
                            Capacity = 4,
                            CategoryId = new Guid("cf0976f2-83c1-4708-afea-3e4785db6d66"),
                            CreatedDate = new DateTime(2025, 10, 20, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("9ebd806d-08e7-40d6-9dc8-408c590c119d"),
                        ...
                        new
                        {
                            Id = new Guid("f0aefde0-bc3d-4cfc-b477-00b3ddec847c"),
                            Address = "9 Forest Trail, Oregon, OR",
                            Capacity = 4,
                            CategoryId = new Guid("d1e68fb1-9cd9-4018-9ba5-cfb9bd315b0d"),
                            CreatedDate = new DateTime(2025, 9, 6, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("965155a6-8b18-45e9-9a60-b92b7876fa69"),
                            Address = "19 Hilltop Rd, Colorado, CO",
                            Capacity = 3,
                            CategoryId = new Guid("d1e68fb1-9cd9-4018-9ba5-cfb9bd315b0d"),
                            CreatedDate = new DateTime(2025, 9, 14, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("9015220b-2e8d-4067-a5cb-9a556260e1da"),
                            Address = "10 Beachfront Ave, Florida, FL",
                            Capacity = 2,
                            CategoryId = new Guid("d1e68fb1-9cd9-4018-9ba5-cfb9bd315b0d"),
                            CreatedDate = new DateTime(2025, 9, 28, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = new Guid("4cbafdc3-446b-4ab3-bf2c-2c0b3c744492"),
                        ...
                        new
                        {
                            Id = new Guid("3abf0f37-8079-4900-bd6b-8679585a5607"),
                        ...
                        new
                        {
                            Id = new Guid("cf0e7c96-b60b-4c6b-8374-57f827fa17a4"),
                        ...
                        new
                        {
                            Id = new Guid("c119661c-1d5a-42c1-8819-6b0885af4d4a"),
                        ...
                        new
                        {
                            Id = new Guid("400c5bff-99c3-4493-a618-6653241bc6b5"),
                        ...
                        new
                        {
                            Id = new Guid("a4e54b1f-3149-4d9b-8d88-e8b4a174a619"),
                        ...
                        new
                        {
                            Id = new Guid("1a491f3d-94ac-4df8-a244-0ef6c4a5c5b2"),
                        ...
                        new
                        {
                            Id = new Guid("a4ab6df6-66b8-46f7-8198-c94332964006"),
                            Address = "15 Sand Dune Rd, Nevada, NV",
                            Capacity = 5,
                            CategoryId = new Guid("6f80d6e0-54b3-495d-847b-16a092c8b626"),
                            CreatedDate = new DateTime(2025, 9, 24, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("Restino.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("8f67819c-0d09-43e8-b64f-17c9123b6040"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("418ade5f-d0b7-4545-b9de-beafbefffa66"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("cf0976f2-83c1-4708-afea-3e4785db6d66"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("d1e68fb1-9cd9-4018-9ba5-cfb9bd315b0d"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("9fbd8bb8-1a85-4305-87fd-4b3d011b1a5a"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("6f80d6e0-54b3-495d-847b-16a092c8b626"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Restino.Domain.Entities.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c4046135-7ef7-4a85-a125-feeea203d4de"),
                            AccommodationId = new Guid("a4ab6df6-66b8-46f7-8198-c94332964006"),
                            AdditionalServices = "test",
                            CheckInDate = new DateTime(2025, 8, 31, 0, 0, 0, 0, DateTimeKind.Local),
                            CheckOutDate = new DateTime(2025, 9, 7, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("Restino.Domain.Entities.Accommodation", b =>
                {
                    b.HasOne("Restino.Domain.Entities.Category", "Category")
            ...
            modelBuilder.Entity("Restino.Domain.Entities.Reservation", b =>
                {
                    b.HasOne("Restino.Domain.Entities.Accommodation", "Accommodation")
                        .WithMany()
